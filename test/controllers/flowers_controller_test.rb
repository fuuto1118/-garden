...
class FlowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flower" do
    assert_difference('Flower.count') do
      post flowers_url, params: { flower: { kana: @flower.kana, name: @flower.name, words: @flower.words } }
    end
  ...
  test "should update flower" do
    patch flower_url(@flower), params: { flower: { kana: @flower.kana, name: @flower.name, words: @flower.words } }
